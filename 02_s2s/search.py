...
# from https://github.com/kh-kim/simple-nmt/blob/master/simple_nmt/search.py

# 참고 https://kh-kim.gitbooks.io/pytorch-natural-language-understanding/content/neural-machine-translation/beam-search.html
