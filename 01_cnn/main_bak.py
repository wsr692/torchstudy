...
from model.cnn import CNN,CNN1d
...
if __name__=='__main__':
	...
	TEXT,train_iterator,valid_iterator,test_iterator,_,_,_=custom_data.tabular2iter(result_path,split_ratio_train_test,split_ratio_train_val,SEED)
